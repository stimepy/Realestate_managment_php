...
$files = array("CXMLParser_class.php", "CTemplate_class.php", "Clayout_class.php", "cconfig_class.php", "CHTML.php", "CDatabase_class.php", "CVars_class.php", "CMenu_class.php", "CSQLAdmin_class.php", "CForms_class.php",  "CBase_Class.php");
