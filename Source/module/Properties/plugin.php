...
class properties_module implements plugin
{
    ...
    function installModule()
    {
        ...
        $tables = array('prop_property' => array('`prop_id` int(11) NOT NULL AUTO_INCREMENT COMMENT \'property id\'',
            ...
            , "prop_files" => array("`prop_file_id` int(10) NOT NULL AUTO_INCREMENT COMMENT 'Unique identifier'",
            ...
            , "prop_unit" => array("`unit_id` int(10) NOT NULL AUTO_INCREMENT COMMENT 'Unit id'",
