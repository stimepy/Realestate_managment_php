    ...
    <div id="Wrapper2">
        ...
        <aside id="sidebar-wrapper">
            ...
            <nav class="sidebar">
                <h1>Recent Posts</h1>
                <ul>
                    <li><a href="#">How to make website Readable [Tips]</a></li>
...
<footer id="copyrights">
    <p><small>&copy; 2012 <a href="#">Domain Name</a></small></p>
    <p><a href="#">About Us</a> - <a href="#">Advertise</a> - <a href="#">Contact Us</a></p>
    <address>
